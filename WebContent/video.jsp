...
<body>
	<div class="header">	
      <div class="container"> 
  	     <div class="logo">
			<h1><a href="index.html">Imazon</a></h1>
		 </div>
		 <div class="top_right">
		   <ul>
	...
	<div class="banner">
		<div class="container">
			<div class="span_1_of_1">
			    <h2>Imazon Video Thumbnail Extractor</h2>
			    <div class="search">
			      <ul class="nav1">
		            <li id="search">
						<form action="extractThumbnail" method="POST" enctype="multipart/form-data">
							<input type="file" name="files" id="search_text" placeholder="Search"/>
