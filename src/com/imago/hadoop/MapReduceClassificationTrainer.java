...
public class MapReduceClassificationTrainer extends Configured implements Tool {
	 public static FastVector attributes=null;
  public static void main(String args[]) throws Exception {
    
   
    int res = ToolRunner.run(new MapReduceClassificationTrainer(), args);
    System.exit(res);
  }
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJarByClass(MapReduceClassificationTrainer.class);
  ...
  public static class Map extends Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    public void map(LongWritable key, Text value,
      ...
      Image image=Utilities.getImage(line.substring(line.indexOf(",")+1),line.substring(0,line.indexOf(",")));
...
new FileUpload(mlp_file,"/imago_serialized_ann"+ line.substring(0, line.indexOf(","))+".ann").uploadToHDFS();
  ...
  public static class Reduce extends Reducer<Image, IntWritable, Text, IntWritable> {

    @Override
    public void reduce(Image key, Iterable<IntWritable> values, Context context) throws IOException, InterruptedException {
